...
public class Exercise_01_10 {
	public static void main(String[] args) {
		double runnerInHours = 14.0/1.6;
		double timeInSec = ((45.0 * 60.0) + 30.0)/3600.0;
		double averageMiles = runnerInHours / timeInSec;
		System.out.println("Average speed in Miles " + averageMiles);
